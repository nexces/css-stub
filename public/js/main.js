...
var Slider = (function () {
    function Slider(sliderSelector, sliderConfiguration) {
        ...
        this.heightGuard = function () {
            ...
            _this.containerHeight = _this.$slidesContainer.offsetHeight;
            for (i = 0; i < _this.$$slides.length; i++) {
                $slide = _this.$$slides[i];
